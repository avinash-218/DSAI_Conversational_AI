...
with open("../Utility/DSAI_University_Data") as data:
...
with open("../Utility/DSAI_Course_Data") as data:
    file = csv.reader(data, delimiter=',')
    for row in file:
...
with open("../Utility/DSAI_Student_Data") as data:
    file = csv.reader(data, delimiter=',')
    for row in file:
...
print(g.serialize("../Utility/DSAI_Knowledge_Base.nt", format="nt"))